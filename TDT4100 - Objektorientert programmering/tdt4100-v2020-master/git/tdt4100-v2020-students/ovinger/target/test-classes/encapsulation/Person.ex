  ...
  <exercise:ExerciseProposals exercise="/0">
    <proposals exercisePart="/0/@parts.0">
      ...
      <proposals xsi:type="junit:JunitTestProposal" question="/0/@parts.0/@tasks.2/@q" answer="/0/@parts.0/@tasks.2/@a">
        <attempts xsi:type="junit:JunitTestEvent" timestamp="1579437341350" completion="1.0" testRunName="encapsulation.PersonTest" successCount="5">
          <successTests>testSetBirthday</successTests>
          <successTests>testExtraCountryTopLevelDomains</successTests>
          <successTests>testSetGender</successTests>
          <successTests>testSetName</successTests>
          <successTests>testSetEmail</successTests>
        </attempts>
      </proposals>
    </proposals>
