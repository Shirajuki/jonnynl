  ...
  <exercise:Exercise>
    <parts xsi:type="exercise:ExercisePart" title="LineEditor">
      <tasks xsi:type="exercise:Task">
        ...
        <a xsi:type="jdt:JdtSourceEditAnswer" className="stateandbehavior.LineEditor"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Run the LineEditor class, to test it."/>
        <a xsi:type="jdt:JdtLaunchAnswer" className="stateandbehavior.LineEditor"/>
      </tasks>
      <tasks xsi:type="exercise:Task">
        <q xsi:type="exercise:StringQuestion" question="Test the LineEditor class, by running the LineEditorTest JUnit test."/>
        <a xsi:type="junit:JunitTestAnswer" testRunName="stateandbehavior.LineEditorTest"/>
      </tasks>
    </parts>
  ...
  <exercise:ExerciseProposals exercise="/0">
    <proposals exercisePart="/0/@parts.0">
      ...
      <proposals xsi:type="junit:JunitTestProposal" question="/0/@parts.0/@tasks.2/@q" answer="/0/@parts.0/@tasks.2/@a">
        <attempts xsi:type="junit:JunitTestEvent" timestamp="1579173433988" completion="1.0" testRunName="stateandbehavior.LineEditorTest" successCount="6">
