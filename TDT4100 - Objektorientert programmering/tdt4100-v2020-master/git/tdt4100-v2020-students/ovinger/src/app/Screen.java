...
public class Screen {
	...
	public Screen(String[][] b, Player p, Pane gamePaneElements, List<Tile> gameArr, List<Entity> entityArr, List<String> infoArr, List<Item> itemArr){
		this.board = b;
		this.p = p;
	...
	public boolean newScreen() { return this.newScreen; }
	public String screenState() { return this.screenState; }
	...
	public void drawPlayerInventory(int n, String filter) {
		...
		if (c == 0) text = "No items to be found!";
		Tile t = (Tile)gameArr.get(n);
		double moveX = 5;
		if (filter == "listed") moveX-=1.5;
		int translateX = (int) (Settings.GAME_WIDTH() - moveX*Settings.TILE_SIZE() - (text.length())*Settings.TILE_SIZE()/2);
